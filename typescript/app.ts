...
const resultText = document.getElementById("result")! as HTMLInputElement;

const sourceOption = document.getElementById(
  "source-option"
)! as HTMLInputElement;
const resultOption = document.getElementById(
  "result-option"
)! as HTMLInputElement;
...
function fromEsperantoToCyrillic(esperantoText: string): string {
...
function fromCyrillicToEsperanto(cyrillicText: string): string {
...
function fromEsperantoToGeorgian(georgianText: string): string {
...
function fromGeorgianToEsperanto(cyrillicText: string): string {
  const splittedText = cyrillicText.split("");
  let converted = "";
